      ...
      <div class="col-xl-6 col-lg-6 col-12">
        ...
        <nav>
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <a class="nav-item nav-link" id="nav-fabric-tab" data-toggle="tab" href="#nav-fabric" role="tab" aria-controls="nav-fabric" aria-selected="false">Step 2</a>
            <a class="nav-item nav-link" id="nav-properties-tab" data-toggle="tab" href="#nav-properties" role="tab" aria-controls="nav-properties" aria-selected="false">Step 3</a>
        ...
        <div class="tab-content" id="nav-tabContent">
          <div class="tab-pane fade show active" id="nav-blinds" role="tabpanel" aria-labelledby="nav-blinds-tab">
            <div class="container-fluid">
              <div class="row">
                <p class="lead pt-2 col-sm-8">Select Window Blinds</p>
          ...
          <div class="tab-pane fade " id="nav-fabric" role="tabpanel" aria-labelledby="nav-fabric-tab">
            ...
            <div class="container mt-4 overflow-y">
              <div class="card-columns card-columns-2">
                <div class="card">
                  <img data-toggle="magnify" class="img-fluid cursor-pointer" src="../images/Fabrics/Belgian%20Linen.jpg">
                  <div class="card-body">
                ...
                <div class="clearfix"></div>
                <div class="card">
                  <img data-toggle="magnify" class="img-fluid" src="../images/fabrics/Bella%20Velvet.jpg">
                  <div class="card-body">
...
-->
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                      ...
                      <input type="text" readonly class="col-7 form-control-plaintext" value="Roller Blinds" />
                      <label class="col-5 col-form-label">Fabric</label>
                      <input type="text" readonly class="col-7 form-control-plaintext" value="Belgian Linen" />
                      <label class="col-5 col-form-label">Width</label>
                      <input id="summary-width" type="text" readonly class="col-7 form-control-plaintext" value="" />
                      <label class="col-5 col-form-label">Height</label>
                      <input id="summary-height" type="text" readonly class="col-7 form-control-plaintext" value="" />
    ...
    <input type="checkbox" autocomplete="off"><i class="fas fa-hand-paper text-danger" text-danger></i>
          ...
          <button id="btnText" type="button" class="btn btn-light" data-toggle="tooltip" title="Add Text"><i class="fas fa-font text-danger"></i></button>
          <button id="btnCircle" type="button" class="btn btn-light" data-toggle="tooltip" title="Insert Circle"><span class="fas fa-circle text-danger"></span></button>
          <button id="btnSquare" type="button" class="btn btn-light" data-toggle="tooltip" title="Insert Square"><i class="fas fa-square text-danger"></i></button>
          <button id="btnLine" type="button" class="btn btn-light" data-toggle="tooltip" title="Insert Line"><i class="fas fa-minus text-danger"></i></button>
          <button id="btnTriangle" type="button" class="btn btn-light" data-toggle="tooltip" title="Insert Triangle"><i class="fas fa-play text-danger" data-fa-transform="rotate-270"></i></button>
          <button type="button" class="btn btn-light" data-toggle="tooltip" title="Insert Triangle"><i class="fas fa-play text-danger" data-fa-transform="rotate-270"></i>Reset</button>
